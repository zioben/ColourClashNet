...
namespace ColourClashNet.Color.Dithering
{
    ...
    public abstract partial class DitherBase : DitherInterface
    {
        ...
        public abstract Task<ImageData?> DitherAsync(ImageData imageReference, ImageData imageProcessed, ColorDistanceEvaluationMode colorEvaluationMode, CancellationToken token=default);
    }
}
