...
namespace ColourClashNet.Controls
{
    public partial class ColorTransformer : Component
    {
        ...
        #region Properties
        public int ImageSourceColors => oTrIdentity?.SourceColors ?? 0;
        public int ImageQuantizedColors => oTrQuantization?.SourceColors ?? 0;
        public int ImageProcessedColors => lTransform.LastOrDefault()?.SourceColors ?? 0;
       ...
       // private ColorTransformInterface oTrLast;
        ...
        {
            ToPalette(lTransform.LastOrDefault()?.TransformationColorMap.Select(X=>X.Value).ToList());
            RebuildImageOutput();
        }
        ...
        int[,] RemoveBkg()
        {
            ...
            oTrBkgRemover.Create(oTrIdentity.SourceColorHistogram);
        ...
        void Quantize()
        {
            ...
            oTrQuantization.Create(oTrBkgRemover.SourceColorHistogram);
        ...
        public void WriteBitplane(string sFileName, ImageTools.ImageWidthAlignMode eWidthAlignMode, bool bInterleaveData)
        {
            ...
            {
                ImageTools.ImageTools.BitplaneWriteFile(sFileName, mDataProcessed, oTrLast.SourceColorPalette.ToList(), eWidthAlignMode, bInterleaveData);
            }
        }
